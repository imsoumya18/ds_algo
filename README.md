...
9. [Graph Theory](Graph%20Theory)
   ...
   - [x] [Cycle Detection in Undirected Graph (BFS)](Graph%20Theory/2_cycle_detection.cpp#L10)
   - [x] [Cycle Detection in Undirected Graph (DFS)](Graph%20Theory/2_cycle_detection.cpp#L59)
   - [x] [Cycle Detection in Directed Graph (DFS)](Graph%20Theory/2_1_cycle_detection_directed.cpp#L29)
   - [x] [Cycle Detection in Directed Graph (BFS)](Graph%20Theory/2_1_cycle_detection_directed.cpp#L41)
